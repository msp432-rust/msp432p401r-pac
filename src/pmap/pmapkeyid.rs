...
pub type PMAPKEY_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PMAPKEY` writer - Port mapping controller write access key"]
pub type PMAPKEY_W<'a, const O: u8> = crate::FieldWriter<'a, u16, PMAPKEYID_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Port mapping controller write access key"]
    #[inline(always)]
    pub fn pmapkey(&self) -> PMAPKEY_R {
        PMAPKEY_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - Port mapping controller write access key"]
    #[inline(always)]
    pub fn pmapkey(&mut self) -> PMAPKEY_W<0> {
        PMAPKEY_W::new(self)
    }
