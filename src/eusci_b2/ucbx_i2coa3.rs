...
pub type I2COA3_W<'a, const O: u8> = crate::FieldWriter<'a, u16, UCBXI2COA3_SPEC, u16, u16, 10, O>;
...
pub type UCOAEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCBXI2COA3_SPEC, UCOAEN_A, O>;
