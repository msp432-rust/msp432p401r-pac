...
pub struct W(crate::W<FLCTL_CLRIFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FLCTL_CLRIFG_SPEC>;
    #[inline(always)]
...
#[doc = "Clear Interrupt Flag Register\n\nThis register you can [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [flctl_clrifg](index.html) module"]
pub struct FLCTL_CLRIFG_SPEC;
impl crate::RegisterSpec for FLCTL_CLRIFG_SPEC {
    type Ux = u32;
}
#[doc = "`write(|w| ..)` method takes [flctl_clrifg::W](W) writer structure"]
impl crate::Writable for FLCTL_CLRIFG_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets FLCTL_CLRIFG to value 0"]
impl crate::Resettable for FLCTL_CLRIFG_SPEC {
    #[inline(always)]
