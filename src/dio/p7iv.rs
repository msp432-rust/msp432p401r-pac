...
impl core::convert::From<crate::R<P7IV_SPEC>> for R {
...
pub struct P7IV_R(crate::FieldReader<u8, P7IV_A>);
impl P7IV_R {
    pub(crate) fn new(bits: u8) -> Self {
        P7IV_R(crate::FieldReader::new(bits))
    }
...
impl core::ops::Deref for P7IV_R {
    type Target = crate::FieldReader<u8, P7IV_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
