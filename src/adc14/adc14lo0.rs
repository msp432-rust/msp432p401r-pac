...
impl core::convert::From<crate::R<ADC14LO0_SPEC>> for R {
...
impl core::convert::From<crate::W<ADC14LO0_SPEC>> for W {
    fn from(writer: crate::W<ADC14LO0_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `ADC14LO0` reader - Low threshold 0"]
pub struct ADC14LO0_R(crate::FieldReader<u16, u16>);
impl ADC14LO0_R {
    pub(crate) fn new(bits: u16) -> Self {
        ADC14LO0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADC14LO0_R {
