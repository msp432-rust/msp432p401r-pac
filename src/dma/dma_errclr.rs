...
pub type ERRCLR_R = crate::BitReader<ERRCLR_A>;
impl ERRCLR_R {
...
pub type ERRCLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_ERRCLR_SPEC, ERRCLR_AW, O>;
impl<'a, const O: u8> ERRCLR_W<'a, O> {
