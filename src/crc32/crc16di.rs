...
pub type CRC16DI_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CRC16DI` writer - CRC16 data in"]
pub type CRC16DI_W<'a, const O: u8> = crate::FieldWriter<'a, u16, CRC16DI_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - CRC16 data in"]
    #[inline(always)]
    pub fn crc16di(&self) -> CRC16DI_R {
        CRC16DI_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:15 - CRC16 data in"]
    #[inline(always)]
    pub fn crc16di(&mut self) -> CRC16DI_W<0> {
        CRC16DI_W::new(self)
    }
