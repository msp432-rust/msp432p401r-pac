...
impl core::convert::From<crate::R<CRC32INIRES_LO_SPEC>> for R {
...
impl core::convert::From<crate::W<CRC32INIRES_LO_SPEC>> for W {
...
pub struct CRC32INIRES_LO_R(crate::FieldReader<u16, u16>);
impl CRC32INIRES_LO_R {
    pub(crate) fn new(bits: u16) -> Self {
        CRC32INIRES_LO_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CRC32INIRES_LO_R {
