...
impl core::convert::From<crate::R<CRC16RESR_SPEC>> for R {
...
impl core::convert::From<crate::W<CRC16RESR_SPEC>> for W {
    fn from(writer: crate::W<CRC16RESR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CRC16RESR` reader - CRC16 reverse result"]
pub struct CRC16RESR_R(crate::FieldReader<u16, u16>);
impl CRC16RESR_R {
    pub(crate) fn new(bits: u16) -> Self {
        CRC16RESR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CRC16RESR_R {
