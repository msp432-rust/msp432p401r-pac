...
pub type UCADDR_UCIDLE_R = crate::BitReader<bool>;
#[doc = "Field `UCADDR_UCIDLE` writer - Address received / Idle line detected"]
pub type UCADDR_UCIDLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, bool, O>;
...
pub type UCRXERR_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCRXERR_A, O>;
...
pub type UCBRK_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCBRK_A, O>;
...
pub type UCPE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCPE_A, O>;
...
pub type UCOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCOE_A, O>;
...
pub type UCFE_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCFE_A, O>;
...
pub type UCLISTEN_W<'a, const O: u8> = crate::BitWriter<'a, u16, UCAXSTATW_SPEC, UCLISTEN_A, O>;
